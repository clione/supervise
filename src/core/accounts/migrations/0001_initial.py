...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_userprofile', (
            ...
            ('twitter', self.gf('django.db.models.fields.URLField')(max_length=255, unique=True, null=True, blank=True)),
            ('gplus', self.gf('django.db.models.fields.URLField')(max_length=255, unique=True, null=True, blank=True)),
            ('facebook', self.gf('django.db.models.fields.URLField')(max_length=255, unique=True, null=True, blank=True)),
        ))
    ...
    models = {
        u'accounts.userprofile': {
            ...
            'facebook': ('django.db.models.fields.URLField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'gplus': ('django.db.models.fields.URLField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'twitter': ('django.db.models.fields.URLField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
