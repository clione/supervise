...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'workgroups_workgroup', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='group_author', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'workgroups', ['WorkGroup'])

        # Adding M2M table for field users on 'WorkGroup'
        m2m_table_name = db.shorten_name(u'workgroups_workgroup_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('workgroup', models.ForeignKey(orm[u'workgroups.workgroup'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'workgroups_workgroup')

        # Removing M2M table for field users on 'WorkGroup'
        db.delete_table(db.shorten_name(u'workgroups_workgroup_users'))
