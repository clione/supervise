...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wiki_page', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='page_author', null=True, to=orm['auth.User'])),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_mod', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('last_mod_author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='page_modified_author', null=True, to=orm['auth.User'])),
        ))
    ...
    models = {
        ...
        u'wiki.page': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'page_author'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'content': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'last_mod': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'last_mod_author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'page_modified_author'", 'null': 'True', 'to': u"orm['auth.User']"}),
